# Alphabet Project Roadmap - v2.3.6

**Project Owner: Fraol Teshome**

## Completed (v2.0.0 - v2.3.6)
...
*Status: v2.3.6 Released. Core language and standard library complete. Focus on ecosystem and internationalization.*
